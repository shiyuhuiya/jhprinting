<template>
  <div class="body">
    ...
    <div class="footer">
      <div class="btn-buy" @click="addAddress">保存</div>
    </div>
  </div>
</template>

<script>
import { addAddress, getProvince } from '@/api/address.js'
...
export default {
  ...
  methods: {
    ...
    //添加地址
    async addAddress() {
      const res = await addAddress(this.name, this.phone, this.selectedValues[0], this.selectedValues[1], this.selectedValues[2], this.detail)
      // console.log(res)
